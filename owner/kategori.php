              ...
              <div class="x_panel">
                <div class="x_title">
                  ...
                  <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#staticBackdrop">
                    <i class="fa fa-plus-square" aria-hidden="true"></i> Tambah Kategori
                  </button>
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          ...
                          <td>
                            <a href="detailkategori.php?id_kategori=<?= $row["id_kategori"] ?>" class="btn btn-info"><i class="fa fa-info-circle" aria-hidden="true"></i></a>
                            <a href="hapuskategori.php?id=<?= $row['id_kategori']; ?>" class="btn btn-danger" onclick="return confirm('yakin hapus?');"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                          </td>
                        </tr>
                        <?php $no++; ?>
                      <?php endwhile; ?>
