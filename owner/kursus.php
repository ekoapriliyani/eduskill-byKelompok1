              ...
              <div class="x_panel">
                <div class="x_title">
                  ...
                  <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#staticBackdrop">
                    <i class="fa fa-plus-square" aria-hidden="true"></i> Tambah Kursus
                  </button>
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" id="staticBackdropLabel">Tambah Kursus</h5>
                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                          </button>
                        </div>
                        <form action="proses-kursus.php" method="POST">
                          <div class="modal-body">
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="deskripsi_kursus" name="deskripsi_kursus">
                            </div>
                            <div class="form-group">
                              ...
                              <select id="kategori" class="form-control" name="kategori" required>
                                ...
                                <?php
                                include 'koneksi.php';
                                $result = mysqli_query($conn, "SELECT * FROM tkategori");
                                while ($dep = mysqli_fetch_array($result)):
                                ?>
                                  <option value="<?= $dep['id_kategori']; ?>"><?= $dep['nama_kategori']; ?></option>
                                <?php endwhile; ?>
                              </select>
                            </div>
                            <br><br>
                ...
                <div class="x_content">
                  <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                      ...
                      ?>
                      <?php
                      $result = mysqli_query($conn, "SELECT * FROM tkursus INNER JOIN tkategori ON tkursus.id_kategori = tkategori.id_kategori");
                      ...
                      ?>
                        <tr>
                          ...
                          <td><?= $row["deskripsi_kursus"]; ?></td>
                          <td><?= $row["nama_kategori"]; ?></td>
                          <td>
                            <a href="detailkursus.php?id_kursus=<?= $row["id_kursus"]; ?>" class="btn btn-info"><i class="fa fa-info-circle" aria-hidden="true"></i></a>
                            <a href="hapuskursus.php?id_kursus=<?= $row["id_kursus"]; ?>" onclick="return alert('yakin hapus?');" class="btn btn-danger"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                          </td>
                        </tr>
                        <?php $no++; ?>
                      <?php endwhile; ?>
