      ...
      <div class="right_col" role="main">
        ...
        <form action="" method="POST">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="nama_materi" name="nama_materi" value="<?= $mt["nama_materi"]; ?>" readonly>
          </div>
          <div class="form-group">
            <label for="deskripsi_materi">Deskripsi Materi</label>
            <input type="text" class="form-control" id="deskripsi_materi" name="deskripsi_materi" value="<?= $mt["deskripsi_materi"]; ?>" readonly>
          </div>
          <div class="form-group">
            <label for="file_materi">File Materi</label>
            <input type="text" class="form-control" id="file_materi" name="file_materi" value="<?= $mt["file_materi"]; ?>" readonly>
          </div>
          <br><br>
          <div class="form-group">
            <a href="ubahmateri.php?id_materi=<?= $mt["id_materi"]; ?>" class="btn btn-warning">Edit</a>
