      ...
      <div class="right_col" role="main">
        ...
        <form action="" method="POST">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="nama_kursus" name="nama_kursus" value="<?= $ks["nama_kursus"]; ?>" readonly>
          </div>
          <div class="form-group">
            <label for="deskripsi_kursus">Deskripsi Kursus</label>
            <input type="text" class="form-control" id="deskripsi_kursus" name="deskripsi_kursus" value="<?= $ks["deskripsi_kursus"]; ?>" readonly>
          </div>
          <div class="form-group">
          ...
          <br><br>
          <div class="form-group">
            <a href="ubahkursus.php?id_kursus=<?= $ks["id_kursus"]; ?>" class="btn btn-warning">Edit</a>
            <a href="kursus.php" class="btn btn-primary">Kembali</a>
          </div>
        </form>
      </div>
