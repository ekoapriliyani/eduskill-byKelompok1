...
$result = mysqli_query($conn, "SELECT * FROM tmateri INNER JOIN tkursus ON tmateri.id_kursus = tkursus.id_kursus WHERE id_materi = $id_materi");
      ...
      <div class="right_col" role="main">
        ...
        <form action="" method="POST">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="nama_materi" name="nama_materi" value="<?= $mt["nama_materi"]; ?>" autofocus>
          </div>
          <div class="form-group">
            <label for="deskripsi_materi">Deskripsi Materi</label>
            <input type="text" class="form-control" id="deskripsi_materi" name="deskripsi_materi" value="<?= $mt["deskripsi_materi"]; ?>">
          </div>
          <div class="form-group">
            <label for="file_materi">File Materi</label>
            <input type="text" class="form-control" id="file_materi" name="file_materi" value="<?= $mt["file_materi"]; ?>">
          </div>
          <div class="form-group">
            <label hidden for="id_kursus">ID Kursus</label>
            <input hidden type="text" class="form-control" id="id_kursus" name="id_kursus" value="<?= $mt["id_kursus"]; ?>" readonly>
          </div>
          <br><br>
          <div class="form-group">
            <button type="submit" class="btn btn-info" name="updatemateri">Update</button>
            <a href="materi.php" class="btn btn-danger">Batal</a>
          </div>
        </form>
      </div>
