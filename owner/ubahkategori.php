...
$result = mysqli_query($conn, "SELECT * FROM tkategori WHERE id_kategori = $id_kategori");

$kt = mysqli_fetch_assoc($result);

if (isset($_POST["updatekategori"])) {
  $nama_kategori = $_POST["nama_kategori"];

  $query = "UPDATE tkategori SET
      ...
      <div class="right_col" role="main">
        ...
        <form action="" method="POST">
          <div class="form-group">
            <label for="nama_kategori">Nama Materi</label>
            <input type="text" class="form-control" id="nama_kategori" name="nama_kategori" value="<?= $kt["nama_kategori"]; ?>" autofocus>
          </div>

          <br><br>
          <div class="form-group">
            <button type="submit" class="btn btn-info" name="updatekategori">Update</button>
