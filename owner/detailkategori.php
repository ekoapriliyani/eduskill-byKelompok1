      ...
      <div class="right_col" role="main">
        ...
        <form action="" method="POST">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="nama_kategori" name="nama_kategori" value="<?= $kt["nama_kategori"]; ?>" readonly>
          </div>

          <br><br>
          <div class="form-group">
            <a href="ubahkategori.php?id_kategori=<?= $kt["id_kategori"]; ?>" class="btn btn-warning">Edit</a>
